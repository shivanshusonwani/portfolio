const projects = [
	{
		title: 'Collaborative AI Notes Workspace',
		desc: 'Built a real-time collaborative workspace featuring concurrent document editing and context-aware AI integration, enabling teams to instantly transform raw notes into structured project documentation.',
		tech: ['Generative AI', 'React', 'Context API', 'Node.js', 'MongoDB'],
		live: 'https://collaborative-ai-notes-workspace.vercel.app',
		code: 'https://github.com/shivanshusonwani/Collaborative-AI-Notes-Workspace',
	},
	{
